...
Exemples:
- "Combien de projets?" → SELECT COUNT(*) FROM embeddings WHERE category = 'projet';
- "Liste les compétences" → SELECT corpus, category FROM embeddings WHERE category = 'competence' LIMIT 10;
- "Expérience en Python" → SELECT corpus, extradatas FROM embeddings WHERE corpus ILIKE '%Python%' LIMIT 10;
"""),
